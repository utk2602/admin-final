...
export default function QuestionsPage() {
    ...
    try {
      ...
      if (response.questions && Array.isArray(response.questions)) {
        ...
        if (response.content && response.content[selectedSubDomain]) {
          const newLastKey =
            response.content[selectedSubDomain].last_evaluated_key;
  ...
  const handleAddQuestion = async () => {
    ...
    const filteredOptions = newQuestion.options
      .map((opt) => opt.trim())
      .filter((opt) => opt !== "");

    if (filteredOptions.length !== 0 && filteredOptions.length !== 4) {
      toast.error(
        "Please enter either all 4 options for an objective question or leave all options empty for a subjective question."
      );
      return;
    }
            ...
            <div className="space-y-4">
              ...
              {selectedSubDomain && (
                <div className="text-sm text-gray-300">
                  {loadingCount ? (
                    ...
                    <span>
                      No questions added yet. This will be question #1.
                    </span>
                  ) : (
                    <>
              ...
              <div className="space-y-2">
                <p className="text-sm text-gray-300">
                  Leave all options empty for a subjective question or fill in
                  all 4 for an objective question.
                </p>
          ...
          <Card className="bg-gray-900 border-gradient mt-8">
            <CardContent className="flex flex-col items-center justify-center py-12">
              <p className="text-lg text-gray-400">
                Please select a subdomain to view questions.
              </p>
            </CardContent>
          </Card>
              ...
              {questions.length > 0 ? (
                        ...
                        >
                          ...
                          {isObjective ? (
                            ...
                            <p className="italic text-gray-400">
                              Subjective question (no options)
                            </p>
                          )}
                ...
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  ...
                  <p className="text-gray-500 max-w-md">
                    No questions have been added for the {selectedSubDomain}{" "}
                    subdomain yet. Use the form above to add your first
                    question.
                  </p>
                </div>
              )}
